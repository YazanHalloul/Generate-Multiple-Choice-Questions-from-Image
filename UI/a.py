...
messages = get_messages("""The image is a bar chart displaying sales data in millions of dollars for the years 2011 through 2015. There are two sets of bars for each year, one representing computers and the other representing smartphones. The bars are color-coded: blue for computers and red for smartphones. Each bar's height corresponds to the sales figure 
for that category in that year. The chart has a title at the top indicating the units sold in millions of dollars. The background is white, which makes the colored bars stand out clearly. The chart is likely used to compare the sales trends between 
computers and smartphones over the given period.""")
